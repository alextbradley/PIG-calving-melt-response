function [t_profile,s_profile] = TSprofile_APIGi(zgp1,H,nz, dzT, dzS)
...
% dzT 	:	Shift of thermocline away from 200m default (positive = lowering)
% dzS 	: 	Shift of halocline away from 200m defualt (positive = lowering)
