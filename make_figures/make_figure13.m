%Make figure 13 of the PIG calving manuscript: realistic domain melt rate (2009 geometry) and non-cumulative melt rate anomalies. NB: make_figure10 must be ran first to get the definition of the inner cavity.
